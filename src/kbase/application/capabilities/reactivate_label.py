...
from kbase.application.dto.capabilities import ReactivateLabelInput
...
def reactivate_label(
    data: ReactivateLabelInput,
    *,
    ...
    with SqlAlchemyUnitOfWork(session_factory or get_session_factory()) as uow:
        ...
        label = repos.labels.reactivate_label(label_id=data.label_id)
        record_write(
            repos=repos,
            item_id=None,
            actor_principal_id=data.actor.principal_id,
            operation_key="reactivate_label",
