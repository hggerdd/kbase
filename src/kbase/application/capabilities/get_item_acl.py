...
from kbase.application.dto.capabilities import GetItemAclInput
...
def get_item_acl(
    ...
    *,
    ...
    with SqlAlchemyUnitOfWork(session_factory or get_session_factory()) as uow:
        ...
        return [to_acl_entry_data(entry) for entry in repos.security.list_item_acl(data.item_id)]
