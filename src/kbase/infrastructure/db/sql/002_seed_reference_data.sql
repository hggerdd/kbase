...
INSERT OR IGNORE INTO item_categories (key, label, description, applies_to_kind, parent_key, full_path, depth) VALUES
('research', 'Research', 'Research note or investigation', 'note', NULL, 'research', 0),
('decision', 'Decision', 'Decision note', 'note', NULL, 'decision', 0),
('learning', 'Learning', 'Learning note', 'note', NULL, 'learning', 0),
('reference', 'Reference', 'Reference note', 'note', NULL, 'reference', 0),
('process', 'Process', 'Process or how-to note', 'note', NULL, 'process', 0),
('comparison_note', 'Comparison Note', 'Comparison-oriented note', 'note', NULL, 'comparison_note', 0),
('income_document', 'Income Document', 'Income-related document', 'document', NULL, 'income_document', 0),
('invoice', 'Invoice', 'Invoice or bill', 'document', NULL, 'invoice', 0),
('offer', 'Offer', 'Offer or quotation', 'document', NULL, 'offer', 0),
('bank_statement', 'Bank Statement', 'Bank statement or account extract', 'document', NULL, 'bank_statement', 0),
('insurance_document', 'Insurance Document', 'Insurance-related document', 'document', NULL, 'insurance_document', 0),
('school_document', 'School Document', 'School-related document', 'document', NULL, 'school_document', 0),
('medical_document', 'Medical Document', 'Medical document', 'document', NULL, 'medical_document', 0),
('product_document', 'Product Document', 'Manual or specification', 'document', NULL, 'product_document', 0),
('contract_document', 'Contract Document', 'Contract or agreement', 'document', NULL, 'contract_document', 0),
('scan', 'Scan', 'Scanned image', 'image', NULL, 'scan', 0),
('screenshot', 'Screenshot', 'Screenshot image', 'image', NULL, 'screenshot', 0),
('photo', 'Photo', 'Regular photo', 'image', NULL, 'photo', 0),
('product_reference', 'Product Reference', 'Reference image', 'image', NULL, 'product_reference', 0),
('comparison_table', 'Comparison Table', 'Comparison spreadsheet', 'spreadsheet', NULL, 'comparison_table', 0),
('data_table', 'Data Table', 'General data spreadsheet', 'spreadsheet', NULL, 'data_table', 0),
('task_general', 'General Task', 'General actionable task', 'task', NULL, 'task_general', 0),
('review_task', 'Review Task', 'Task for reviewing something', 'task', NULL, 'review_task', 0),
('household_task', 'Household Task', 'Task related to household', 'task', NULL, 'household_task', 0),
('admin_task', 'Admin Task', 'Administrative task', 'task', NULL, 'admin_task', 0),
('appointment', 'Appointment', 'Scheduled appointment', 'event', NULL, 'appointment', 0),
('deadline_event', 'Deadline Event', 'Deadline represented as event', 'event', NULL, 'deadline_event', 0),
('family_event', 'Family Event', 'Family-related event', 'event', NULL, 'family_event', 0),
('school_event', 'School Event', 'School-related event', 'event', NULL, 'school_event', 0),
('project_general', 'Project', 'General project context', 'project', NULL, 'project_general', 0),
('case_context', 'Case Context', 'Case or process context', 'project', NULL, 'case_context', 0),
('topic_space', 'Topic Space', 'Topic-based workspace', 'project', NULL, 'topic_space', 0),
('life_area', 'Life Area', 'Long-lived life area context', 'project', NULL, 'life_area', 0);
