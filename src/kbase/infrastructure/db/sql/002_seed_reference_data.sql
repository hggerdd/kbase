...
('capture', 'Capture', 'Quick capture, raw notes, observations, and inbox notes', 'note', NULL, 'capture', 0),
('thinking', 'Thinking', 'Active thinking, analysis, comparison, and decisions', 'note', NULL, 'thinking', 0),
('knowledge', 'Knowledge', 'Reusable knowledge, references, learning, and how-to material', 'note', NULL, 'knowledge', 0),
('planning', 'Planning', 'Plans, ideas, review notes, and follow-up notes', 'note', NULL, 'planning', 0),
('quick_note', 'Quick Note', 'Fast note captured before structure is clear', 'note', 'capture', 'capture/quick_note', 1),
('meeting_note', 'Meeting Note', 'Notes captured from a meeting or conversation', 'note', 'capture', 'capture/meeting_note', 1),
('observation', 'Observation', 'Observed fact, signal, or situation note', 'note', 'capture', 'capture/observation', 1),
('inbox_note', 'Inbox Note', 'Unprocessed note waiting for triage', 'note', 'capture', 'capture/inbox_note', 1),
('research', 'Research', 'Research note or investigation', 'note', 'thinking', 'thinking/research', 1),
('comparison_note', 'Comparison Note', 'Comparison-oriented note', 'note', 'thinking', 'thinking/comparison_note', 1),
('analysis', 'Analysis', 'Analysis note that interprets available information', 'note', 'thinking', 'thinking/analysis', 1),
('decision', 'Decision', 'Decision note', 'note', 'thinking', 'thinking/decision', 1),
('reference', 'Reference', 'Reference note', 'note', 'knowledge', 'knowledge/reference', 1),
('learning', 'Learning', 'Learning note', 'note', 'knowledge', 'knowledge/learning', 1),
('process', 'Process', 'Process or how-to note', 'note', 'knowledge', 'knowledge/process', 1),
('how_to', 'How To', 'Reusable how-to instructions', 'note', 'knowledge', 'knowledge/how_to', 1),
('plan', 'Plan', 'Planning note for intended work or direction', 'note', 'planning', 'planning/plan', 1),
('idea', 'Idea', 'Idea or option that may be developed later', 'note', 'planning', 'planning/idea', 1),
('review_note', 'Review Note', 'Review, retrospective, or assessment note', 'note', 'planning', 'planning/review_note', 1),
('follow_up', 'Follow Up', 'Follow-up note for next actions or open loops', 'note', 'planning', 'planning/follow_up', 1),
